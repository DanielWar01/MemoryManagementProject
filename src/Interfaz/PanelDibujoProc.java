	...
	public class PanelDibujoProc extends JPanel{
	    ...
	    public void paint(Graphics g) {
	    	...
	    	if(modelo == 1) {
	        	...
	        	g.setFont(new Font("Tahoma", Font.BOLD, 7));		//Tama�o del texto en el dibujo
	        	
	        	//Calculando tama�o del S.O. para ser dibujada
	        	...
	        	for(int i=1; i<particionesEstFijas.getParticiones().length;i++) {
	        		...
	        		//Verificar si hay proceso en la particion, si lo hay calcular el tama�o
